 ...
 * @author fistashkin
 */
class DbCarouselIndex extends DbCarousel
{
...
//        print_r($this->options);die;
    ...
    public function renderItems()
    {
        ...
        return Html::tag('div', implode("\n", $items), ['class' => 'banner__wrap banner__wrap--main']);
    }
    ...
    public function renderIndicators()
    {
        ...
        return Html::tag('ul', '', ['class' => 'banner__nav banner__nav--main']);
...
//            }
            ...
            throw new InvalidConfigException('The "caption" option is required.');
        }
...
//        }
        $content = Html::tag('div', $content, ['class'=>'banner__main-text']);
            Html::addCssStyle($options, ['background-image' => 'url(img/banner__slide--main.png)']);
        if ($index === 0) {
...
//        $this->registerPlugin('carousel');
        ...
        $content = Html::tag('div', $content, ['class' => 'container']);
